...
bool Merger::merge()
{
    ...
    qWarning("Merged %s", qPrintable(changes.join("\n\t")));
                                                               ...
                                                               Group::MergeMode mergeMethod)
{
    ...
    if (comparison < 0) {
        ...
        qWarning("Try merge %s/%s with alien on top under %s",
