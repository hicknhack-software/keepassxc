...
static const char* rsa_2_private =
        ...
        "-----END RSA PRIVATE KEY-----\n";
static const char* rsa_2_public =
        ...
        "-----END RSA PUBLIC KEY-----\n";
static const char* rsa_2_sign =
        "4fda1b39f93f174cdc79ac2bd6118155359830c90e2c39b60a1a548852f2c87a"
...
//static const char* rsa_openssl_private =
//        "-----BEGIN RSA PRIVATE KEY-----\n"
//        "MIIEowIBAAKCAQEAylgPssgGxC6QBok6PBCSHmG0XUpdXzWD4Bz/Rp/V8BUwY4F6\n"
//        "wj8FB3/n5KCU7V4s7cpxPzXFC4Qmb5/8iuN/t6oStHpvNOrBkTNdRX+Vv7jliomN\n"
//        "urvJdCwuV0jobdwZ8hog6o9ujH86sSy6bPGVqh8uKzpRFq57bJ66Ji7BbyNrSdYR\n"
//        "/lgwyIXC+BS3V+73S7+nHMl85VB2Jufkl8e7O+l5buJAMcpKDkqj98XkIRk80DvW\n"
//        "tF0/67f932L8EkKWCeyaqZk1eBPCxMdNewLRQs6LyYsjRfudPYEjAL2o0l7/kqYo\n"
//        "5IWrTOhu8ffL6mGkl1bX4Wq9rgGf5lXxbv5FEwIDAQABAoIBAFMFsts+K1iPalTk\n"
//        "NVqzyeBhYmnsu0b3ZDaubyeBKXyqlQIe/El7Jgsftfwezzxdqb2flLvEyiahgEvI\n"
//        "rwwlsB+hzq7ylXJ26Bk1pA2B/eV+beBb9CUsK8pY3mK97XA2IQcvJVZYp5lKEsDj\n"
//        "g1J0BV6aEI14DhFqYgX9Uo+cG44HlVQ81jl7pChHIqq3I4qAW7syiouZWBGKhNd+\n"
//        "K7zUMKrTkN5OrR86desT4/kr3fk5r6g0K5VyhoFSDtvrm7/nao1jRuacnG4813Jg\n"
//        "tR8Hm4D/VIskzHB/ZqzLEBjPwDJg6LxyETxWqGxz4c8+gm4GJhwwxRVDgnfFh5F9\n"
//        "FZenl3ECgYEA7++KEs2wwxi/K/ZPu6aIx9fc7mjMho/xbygeVWX9LPWvPyO8HCn/\n"
//        "gVezPe+cgnJajh+JrjOEA2F4+Qs2lb89m4Pr+q4scN9NUtkN7MNoaCaLEHvzxuov\n"
//        "fa6ychHZVegmpA9PVAcq4VgLJIUHhLMR4QzCm+Fp46IkcDXLOIuqivcCgYEA1+Q0\n"
//        "tLNPuy6wCXEjsDg+xOzUGc74OWyE1pM3vDdBrZr5gweUFhMbLmnDwMTa2PYODdFa\n"
//        "IsaX0EvJsHq8T6uy/Ff7q/DODh+NDVE6Tlh4Py1pQy+lkajk3WPfnBXBTHpdkjQf\n"
//        "dvPwDzckQJcD376lbQl08Etl8MS/ZOXxwmHXE8UCgYEAooH3Xqz6H+nO8ZOuhUZS\n"
//        "Nii6dq98d1dfCw59HRIq3By7SWSGr/yyFYS03ipAMwoI02IA+n/h1fha2zMBEYOp\n"
//        "0n8TgYIej4Ru9sIUcFwZhxEz90I85mkPKWz9Z803CrxmD5BfBmakYGQlh+KiKPqw\n"
//        "DWF7HeEauxbC301QC0hthhkCgYA/6s177laduX3e3cNOKejTjrZhCbjN74YIrT9k\n"
//        "Fwv35RkYJQc/3do/TIrrKJ0OfRK+HoxMHXXW8ok9GallARWVxkq5piqrXcX5+mGD\n"
//        "zoeTVNOEU7f2PwW7UhVi9cHr7ZKEdbAXHLOnHZE7GjrIZH4/oPwhJIGC3g04Ryfj\n"
//        "f+oYbQKBgF+Iojh9j3xX1S4cxctJrzA9JyvdnLqXybJFsCqnVGEDTYj4lbXQJFQL\n"
//        "hV9CTuVNQx3Vnoec7KHoPlK75flVcDWTKgjuAtoTVrB8APyuPiFimKyk6zRugo0l\n"
//        "t6g09AZugN1qmHcPcZct0CUa1i6qXLkmh9vIa45ErP4eKg2WodT4\n"
//        "-----END RSA PRIVATE KEY-----\n";
//static const char* rsa_openssl_public =
//        "-----BEGIN PUBLIC KEY-----\n"
//        "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAylgPssgGxC6QBok6PBCS\n"
//        "HmG0XUpdXzWD4Bz/Rp/V8BUwY4F6wj8FB3/n5KCU7V4s7cpxPzXFC4Qmb5/8iuN/\n"
//        "t6oStHpvNOrBkTNdRX+Vv7jliomNurvJdCwuV0jobdwZ8hog6o9ujH86sSy6bPGV\n"
//        "qh8uKzpRFq57bJ66Ji7BbyNrSdYR/lgwyIXC+BS3V+73S7+nHMl85VB2Jufkl8e7\n"
//        "O+l5buJAMcpKDkqj98XkIRk80DvWtF0/67f932L8EkKWCeyaqZk1eBPCxMdNewLR\n"
//        "Qs6LyYsjRfudPYEjAL2o0l7/kqYo5IWrTOhu8ffL6mGkl1bX4Wq9rgGf5lXxbv5F\n"
//        "EwIDAQAB\n"
//        "-----END PUBLIC KEY-----\n";
static const char* rsa_1_private =
        "-----BEGIN RSA PRIVATE KEY-----\n"
        ...
        "-----END RSA PRIVATE KEY-----\n";
static const char* rsa_1_public =
        "-----BEGIN RSA PUBLIC KEY-----\n"
...
void TestSignature::testSigningOpenSSH_RSA_PrivateOnly()
{
    ...
    privateKey.openPrivateKey(QString());
...
void TestSignature::testSigningOpenSSH_RSA()
{
    ...
    publicKey.openPrivateKey(QString());
...
//void TestSignature::testSigningOpenSSL_RSA_PrivateOnly()
//{
//    OpenSSHKey privateKey;
//    privateKey.parse(rsa_openssl_private);
//    privateKey.openPrivateKey(QString());
//    QCOMPARE(privateKey.fingerprint(), QString("SHA256:jJs0hcwAOamb8TzDH0iSrpvRvtocVW79CdFrN0P2KSs"));
//    Signature signer;
//    const QString sign = signer.create(data, privateKey);
//    QVERIFY(! sign.isEmpty());
...
//void TestSignature::testSigningOpenSSL_RSA()
//{
//    OpenSSHKey privateKey;
//    privateKey.parse(rsa_openssl_private);
//    privateKey.openPrivateKey(QString());
...
//    OpenSSHKey publicKey;
//    publicKey.parse(rsa_openssl_public);
//    publicKey.openPrivateKey(QString());
//    QCOMPARE(publicKey.fingerprint(), QString("SHA256:jJs0hcwAOamb8TzDH0iSrpvRvtocVW79CdFrN0P2KSs"));
//    Signature verifier;
//    const bool verified = verifier.verify(data, sign, publicKey);
//    QCOMPARE(verified, true);
//}
...
void TestSignature::testSigningOpenSSH_DSA_PrivateOnly()
{
    OpenSSHKey privateKey;
    privateKey.parsePKCS1PEM(dsa_private);
    privateKey.openPrivateKey(QString());
    QCOMPARE(privateKey.fingerprint(), QString("SHA256:/7qz6YjayfFE/Y47K72O3BRb+GGrtq94BdjUy3VUeBI"));
    Signature signer;
    const QString sign = signer.create(data, privateKey);
    QVERIFY(! sign.isEmpty());
...
//void TestSignature::testSigningOpenSSH_DSA()
//{
//    OpenSSHKey privateKey;
//    privateKey.parsePKCS1PEM(dsa_private);
//    privateKey.openPrivateKey(QString());
...
//    OpenSSHKey publicKey;
//    publicKey.parseSSH(dsa_public);
//    publicKey.openPrivateKey(QString());
//    QCOMPARE(publicKey.fingerprint(), QString("SHA256:/7qz6YjayfFE/Y47K72O3BRb+GGrtq94BdjUy3VUeBI"));
//    Signature verifier;
//    const bool verified = verifier.verify(data, sign, publicKey);
//    QCOMPARE(verified, true);
//}
